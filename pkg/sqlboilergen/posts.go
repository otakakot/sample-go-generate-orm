...
func (q postQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Post, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboilergen: failed to execute a one query for posts")
	}
...
func (q postQuery) All(ctx context.Context, exec boil.ContextExecutor) (PostSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "sqlboilergen: failed to assign all query results to Post slice")
	}
...
func (q postQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: failed to count posts rows")
	}
...
func (q postQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlboilergen: failed to check if posts exists")
	}
...
func FindPost(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Post, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboilergen: unable to select from posts")
	}
...
func (o *Post) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboilergen: no posts provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboilergen: unable to insert into posts")
	}
...
func (o *Post) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlboilergen: unable to update posts, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: unable to update posts row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: failed to get rows affected by update for posts")
	}
...
func (q postQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: unable to update all for posts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: unable to retrieve rows affected for posts")
	}
...
func (o PostSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: unable to update all in post slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: unable to retrieve rows affected all in update all post")
	}
	return rowsAff, nil
}
...
func (o *Post) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("sqlboilergen: no posts provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("sqlboilergen: unable to upsert posts, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(postPrimaryKeyColumns) == 0 {
				return errors.New("sqlboilergen: unable to upsert posts, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboilergen: unable to upsert posts")
	}
...
func (o *Post) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("sqlboilergen: no Post provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: unable to delete from posts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: failed to get rows affected by delete for posts")
	}
...
func (q postQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("sqlboilergen: no postQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: unable to delete all from posts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: failed to get rows affected by deleteall for posts")
	}
...
func (o PostSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilergen: unable to delete all from post slice")
	}
...
func (o *PostSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboilergen: unable to reload all in PostSlice")
	}
...
func PostExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlboilergen: unable to check if posts exists")
	}
